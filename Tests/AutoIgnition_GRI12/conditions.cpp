                ...
                vector<string> &trajectory_ref) //Name of a reference trajectory defined by the user for the plots 
{
   ...
   for (std::string line; getline(input,line);)
   {
      ...
      read_double("MassFlowRateGB", &MassFlowRateGB, line);
      ...
      if (line == "//EndInletGB")
      {
         ...
         MGB = new Characteristics_MultipleInlet(T, P, MassFlowRateGB, Xk, Yk, EvaporationModel, DropletDiameter, EvaporationTime, liquidDensity, EvaporationLatentHeat, MixingTime, TimeStep, IterationNumber, true );
