...
*/
      ...
      if (configuration == "PremixedFlames")
      {
        ...
        Script_gnuplot("DRGEP_Species", initial_mech, speciesToPlot, configuration, mech_desc, nbSpeciesToKeep, plot_U, plot_T, trajectory_ref, mech_ref, nbInlets, listTargets,outputSchemeName, rank ) ;
