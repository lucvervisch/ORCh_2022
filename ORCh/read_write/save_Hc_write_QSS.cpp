...
//   write << "extern string mech;" << endl;
   ...
   {
      write << endl << endl;
      write << "extern StFow* flow;" << endl;

      write << endl << endl << endl << endl;
      write << "int Mechanism = 1;" << endl;
   ...
   if (Dimension == "0D")
   {
      ...
      write << "   vector<Species*> listSpecies;;" << endl;
      write << "   " << endl;
...
//      write << "  r->Read_species(mech, listSpecies); " << endl;
      ...
      write << "   for (int k=0; k<nsp; k++)" << endl;
      write << "   {" << endl;
      write << "      C[k] = density*(mass[k]/total_mass)/mw[k];" << endl;
      write << "   }" << endl;
      write << "   " << endl;
      write << "   " << endl;
      write << "   for (int k=0; k<nsp; k++)" << endl;
   ...
   write << " /* " << endl;
   write << "    ----------------------------------------------------------- " << endl;
   write << "    A reduced chemical scheme applied to kerosene-air combustion " << endl;
   write << "    Email: andrea.seltz@coria.fr " << endl;
   write << "    Reference: ... " << endl;
   write << "    ----------------------------------------------------------- " << endl;
   write << " */ " << endl;
   write << endl;
...
//                   term = true;
                 ...
                 {
                    cout << "A Warning stoichiometric value different from 1 or 2 or 3 for reaction " << j << endl;
                   write << "-" << listReactions[j]->m_ReactantStoichCoeffs[ka]  << "*ROP[" << j << "] ";
                   term = true;
                 }
...
void Write_QSS::Check_Non_Linearity(string mech, vector<vector<double> > QSS_Criteria) const
{
   vector<Species*> listSpecies;
   vector<Reaction*> listReactions;
...
int Write_QSS::Get_species_number(string species, vector<Species*> listSpecies) const
{
